...
def validate(
    ...
    *,
    ...
    qty = position_qty(signal.entry, signal.stop_loss, capital, capital_cfg.max_risk_pct, leverage)
    if qty == 0:
    ...
    if opposing:
        ...
        room_r = abs(nearest - signal.entry) / rps
    ...
    return TradePlan(
        ...
        margin_required=margin_required(qty, signal.entry, leverage),
